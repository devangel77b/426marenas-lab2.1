...
% set PDF metadata
\hypersetup{%
pdftitle={Testing Newton's second law in an accelerating system},
pdfauthor={Miguel Arenas, Callie Butash, Jake Chin, Kriti Malhotra, Grace Nealon, and Petra Rofman},
}
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[RE,RO]{J S\&E \textbf{1}, 1--3 (2024)}
\fancyhead[LO]{Arenas et al.}
\fancyhead[LE]{Testing Newton's second law}
\fancyfoot[C]{\thepage}
\fancypagestyle{mytitlepage}{
\fancyhf{}
\fancyhead[C]{Journal of Science \& Engineering \textbf{1}, 1--3 (2024)}
\fancyfoot[C]{\thepage}
}
